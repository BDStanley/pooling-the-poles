...
cat("Pooled polls of intended voting at parliamentary elections in Poland, ", format(Sys.time(), '%A %d %b'),".", sep="")
```

```{r, echo=F, results='asis'}
cat("Data from CBM Indicator, CBOS, Estymator, IBRIS, IBSP, IPSOS, Kantar, Opinia24, PGB Opinium, Pollster, Research Partner, Social Changes, UCE Research and United Survey.", sep="")
```
