...
theme_plots <- function(base_size = 11, base_family = "IBM Plex Sans", prior = FALSE) {
  ret <- theme_bw(base_size, base_family) +
    theme(panel.background = element_rect(fill = "#ffffff", colour = NA),
          title = element_text(size = rel(1), family = "IBM Plex Sans", face = "bold"),
          plot.subtitle = element_text(size = rel(0.8),
                                       family = "IBM Plex Sans", face = "plain"),
